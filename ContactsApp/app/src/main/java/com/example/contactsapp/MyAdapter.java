...
import com.example.contactsapp.databinding.ContactsLayoutBinding;
...
public class MyAdapter extends RecyclerView.Adapter<MyAdapter.ContactViewHolder> {
    ...
    public ContactViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        ContactsLayoutBinding contactListItemBinding =
    ...
    class ContactViewHolder extends RecyclerView.ViewHolder{
        ...
        private ContactsLayoutBinding contactListItemBinding;

        public ContactViewHolder(@NonNull ContactsLayoutBinding contactListItemBinding) {
